...
class TestRepr:
    def test_polynomial_repr(self):
        ...
        tgt = (
            "Polynomial([0.0, 1.0], domain=[-1, 1], window=[-1, 1], symbol='x')"
        )
        assert_equal(res, tgt)
    ...
    def test_chebyshev_repr(self):
        ...
        tgt = (
            "Chebyshev([0.0, 1.0], domain=[-1, 1], window=[-1, 1], "
            "symbol='x')"
        )
        assert_equal(res, tgt)
    ...
    def test_legendre_repr(self):
        ...
        tgt = (
            "Legendre([0.0, 1.0], domain=[-1, 1], window=[-1, 1], "
            "symbol='x')"
        )
        assert_equal(res, tgt)
    ...
    def test_hermite_repr(self):
        ...
        tgt = (
            "Hermite([0.0, 1.0], domain=[-1, 1], window=[-1, 1], "
            "symbol='x')"
        )
        assert_equal(res, tgt)
    ...
    def test_hermiteE_repr(self):
        ...
        tgt = (
            "HermiteE([0.0, 1.0], domain=[-1, 1], window=[-1, 1], "
            "symbol='x')"
        )
        assert_equal(res, tgt)
    ...
    def test_laguerre_repr(self):
        ...
        tgt = (
            "Laguerre([0.0, 1.0], domain=[0, 1], window=[0, 1], "
            "symbol='x')"
        )
        assert_equal(res, tgt)
