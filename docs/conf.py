...
project = "orthax"
copyright = "2024, Rory Conlin"
author = "Rory Conlin"
version = orthax.__version__
release = version
...
top_level = "orthax"
linkcode_blob = "head"
linkcode_url = r"https://github.com/f0uriest/orthax/"
...
latex_elements = {
    ...
    \begin{titlepage}
        ...
        \centering
        \textbf{\Huge {orthax Documentation}}
